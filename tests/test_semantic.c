...
void test_if_simple_id_error(void) {
...
void test_if_else_simple_id_error(void) {
...
void test_if_else_simple_id_newlines_error(void) {
	const char* data = "if \n a \n { \n } \n else \n { \n }";
	Input in = {
		.type = INT_STRING,
		.string = {
...
void test_if_let_simple_id(void) {
	const char* data = "let a: Double? = 3.7 \n if let b { }";
	Input in = {
		.type = INT_STRING,
		.string = {
			.s = data,
...
void test_if_let_simple_id_error(void) {
...
//TODO: test_if_let_else_simple_id
void test_if_let_else_simple_id_error(void) {
...
//TODO: dodělat test_if_let_else_simple_id_newline_error
void test_if_let_else_simple_id_newlines_error(void) {
	const char* data = "if \n let \n b \n { \n } \n else \n { \n }";
	Input in = {
		.type = INT_STRING,
		.string = {
...
int main(void) {
	...
	RUN_TEST(test_if_simple_id_error);
	// RUN_TEST(test_if_else_simple_id);
    RUN_TEST(test_if_else_simple_id_error);
	// RUN_TEST(test_if_else_simple_id_newlines);
    RUN_TEST(test_if_else_simple_id_newlines_error);
	// RUN_TEST(test_if_let_simple_id);
    RUN_TEST(test_if_let_simple_id_error);
	// RUN_TEST(test_if_let_else_simple_id);
    RUN_TEST(test_if_let_else_simple_id_error);
	// RUN_TEST(test_if_let_else_simple_id_newlines);
    RUN_TEST(test_if_let_else_simple_id_newlines_error);
